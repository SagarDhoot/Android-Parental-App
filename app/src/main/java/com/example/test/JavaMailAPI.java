...
public class JavaMailAPI extends AsyncTask<Void, Void, Void> {
    ...
    public JavaMailAPI(String email, String subject, String message, File attachfile, boolean isScreenshot) {
        this.email = email;
    ...
    protected Void doInBackground(Void... voids) {
        ...
        try {
            ...
            Log.d("MailJ","Inside JavaMailAPI");
            ...
            if (isScreenshot) {
                attachmentBodyPart.setHeader("Content-ID", "<screenshot>");
...
//    }
//
//    public JavaMailAPI(String email, String user, String pass, String host, boolean isSSL ) {
//        this();
//        _from = email;
